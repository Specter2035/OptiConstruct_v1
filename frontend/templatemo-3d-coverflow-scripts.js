        ...
        const imageData = [
            {
                ...
                description: "Observa de manera clara los recursos que utilizarás para tus proyectos"
            },
            {
                title: "Analiza tus planos",
                description: "Descubre cómo utilizar los recursos de manera óptima"
            },
            {
                title: "Encuentra sucursales de manera fácil",
                description: "Por medio de geolocalización podrás descubrir sucursales cercanas"
            },
            {
                title: "Compara precios",
                description: "Descubre y compara los mejores lugares para comprar tus materiales"
            },
            {
                title: "Optimiza tu presupuestoDunes",
                description: "Haz seguimiento de gastos y reduce costos innecesarios"
            },
            {
                title: "Planifica con precisión",
                description: "Consulta planos y obtén una vista clara de cada recurso asignado"
            },
            {
                title: "Consulta planos y obtén una vista clara de cada recurso asignado",
                description: "Visualiza el uso de materiales y evita desperdicios"
            }
        ];
